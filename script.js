...
const savedColors = ['00D8FF', '408BFB', getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor()];
const presets = {
  1: {
...
function showError(show, text = 'Текст превышает 256 символов и может не поместиться в поле чата.') {
  if (show) {
